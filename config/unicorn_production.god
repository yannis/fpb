RAILS_ROOT = "/Users/yannis/railsapps/fpb_production/current"

God.watch do |w|
  pid_file = File.join(RAILS_ROOT, "tmp/pids/fpb_production_unicorn.pid")

  w.name = "fpb_production_unicorn"
